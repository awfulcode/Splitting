!(function (n, t) {
  ...
  function g(n, e, r, o, u) {
    ...
    return (
      m(n.childNodes).some(function (n) {
        var t;
        n.tagName && !n.hasChildNodes()
          ? s.push(n)
          : n.childNodes && n.childNodes.length
          ? (s.push(n), i.push.apply(i, g(n, e, r, o, u)))
          : (t = (n = n.wholeText || "").trim()).length &&
            (" " === n[0] && s.push(a(" ")),
            h(
              "" === r && "function" == typeof Intl.Segmenter
                ? Array.from(new Intl.Segmenter().segment(t)).map(function (n) {
                    return n.segment;
                  })
                : t.split(r),
              function (n, t) {
  ...
  function b(t) {
    ...
    return m(t.target || "[data-splitting]").map(function (i) {
      ...
      return (
        (!t.force && s) ||
          ((s = i["🍌"] = { el: i }),
          (n = e((n = (n = t.by || p(i, "splitting")) && "true" != n ? n : y))),
          (c = (function (n, t) {
  ...
  var S = n("lines", [s], "line", function (n, t, e) {
    ...
    M = n(C, v, v, function (n, t) {
      for (
        var e,
          r = (t.rows = +(t.rows || p(n, "rows") || 1)),
          o = (t.columns = +(t.columns || p(n, "columns") || 1)),
          u =
            ((t.image = t.image || p(n, "image") || n.currentSrc || n.src),
            t.image && ((e = m("img", n)[0]), (t.image = e && (e.currentSrc || e.src))),
            t.image && l(n, "background-image", "url(" + t.image + ")"),
            r * o),
          i = [],
          c = d(v, "cell-grid");
        u--;
